INSERT INTO USER (ID, USER_ID, PASSWORD, NAME, EMAIL, CREATE_DATE) VALUES('1', '1', '1', '계정', 'test@test', CURRENT_TIMESTAMP());
INSERT INTO USER (ID, USER_ID, PASSWORD, NAME, EMAIL, CREATE_DATE) VALUES('2', '2', '2', '계정2', 'test2@test2', CURRENT_TIMESTAMP());
